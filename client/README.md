...
- The UI shows the latest analytics events from Kafka under the "Analytics (Kafka)" card.
- Ensure the backend has `KAFKA_BROKERS` configured; otherwise, the list will stay empty.
